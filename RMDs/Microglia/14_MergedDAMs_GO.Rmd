...
```{r}
library(qs)
macs <- qread("/Users/nate/Desktop/Mikes_ATF3_Data/Cell_Type_Objects/3_annotatedMicroglia.qs")
macs.markers <- read.csv("/Users/nate/Desktop/Mikes_ATF3_Data/CSVs/DEGs_by_Cluster_by_Genotype_MergedDAMs.csv")
```
...
macs.markers.cluster<-filter(macs.markers, clusterID ==5) #Select the 
