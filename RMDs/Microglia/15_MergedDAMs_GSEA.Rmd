...
macs.markers <- read.csv("DEGs_by_Cluster_by_Genotype_MergedDAMs.csv")
...
```{r}
setwd('/Users/nate/Desktop/Mikes_ATF3_Data/CSVs/')
macs.markers <- read.csv("DEGs_by_Cluster_by_Genotype_MergedDAMs_KOselected.csv")
